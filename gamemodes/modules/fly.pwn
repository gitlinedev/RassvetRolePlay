...
{
	if(CheckAccess(playerid, 1, 3)) return 0;
    usefly[playerid] = !usefly[playerid];
    return 1;
}
stock fly_OnPlayerKeyStateChange(playerid, newkeys)
{
...
stock fly_OnPlayerUpdate(playerid)
{
...
stock fly_OnPlayerDeath(playerid)
{
    fly[playerid] = false;
}