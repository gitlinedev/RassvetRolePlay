...
stock OtherMapping()
{
    ...
    Create3DTextLabel("{008000}Выход", -1, 2055.4277,1644.6300,-40.6281, 10.0, 1, 0);
    MineExit= CreateDynamicPickup(1318, 23, 2055.4277,1644.6300,-40.6281, -1);

    MineClothes = CreatePickup(1275, 23, 2047.5870,1634.5970,-40.6281, -1); // шахта закончить/начать 

    Create3DTextLabel("{008000}Лифт", -1, 2045.7982,1630.7396,-40.6281, 10.0, 1, 0);
    MineLift_up = CreatePickup(1318, 23, 2045.7982,1630.7396,-40.6281, -1);

    Create3DTextLabel("{008000}Лифт", -1, 2038.6838,1649.3331,-44.4953, 10.0, 1, 0);
    MineLift_down = CreatePickup(1318, 23, 2038.6838,1649.3331,-44.4953, -1);

    MinePoint_1 = CreatePickup(19133, 23, 2073.5715,1629.3037,-44.5018, -1); // шахта место добычи
    MinePoint_2 = CreatePickup(19133, 23, 2068.8938,1621.1738,-44.5063, -1); // шахта место добычи
    MinePoint_3 = CreatePickup(19133, 23, 2079.5654,1621.8695,-44.5135, -1); // шахта место добычи
    MinePoint_4 = CreatePickup(19133, 23, 2067.1431,1636.3265,-44.5263, -1); // шахта место добычи
    MineDropOre = CreatePickup(19135, 23, 2050.5593,1651.9965,-44.4953, -1); // шахта место сдачи
    //=============================[ ШАХТА ]=============================//
    ...
    Create3DTextLabel("{008000}Автошкола", -1, -572.9996,-1321.7754,42.0646, 10.0, 0);
    PAR_vhod = CreateDynamicPickup(1318, 23, 2126.6987,-1962.8444,20.3229, -1);
    AutoSchool_Enter = CreateDynamicPickup(1318, 23, -572.9996,-1321.7754,42.0646, -1);
    ...
    Create3DTextLabel("{FFFF00}Покупка\nметалла", -1, 2806.9888,2691.7205,15.2110, 20.0, 0);
	...
	//бурсик
	CreateObject(16338, -112.58, -985.76, 39.88,   0.00, 0.00, 0.00);
	CreateObject(16417, -230.57, -1032.31, 40.96,   0.00, 0.00, 0.00);
	CreateObject(16452, -444.01, -1381.39, 38.18,   0.00, 0.00, 0.00);
	CreateObject(16339, 164.98, -598.97, 23.10,   0.00, 0.00, 0.00);
	CreateObject(16340, 531.41, -198.82, 7.79,   0.00, 0.00, 0.00);
	CreateObject(16341, 865.70, 58.10, 11.90,   0.00, 0.00, 0.00);
	CreateObject(16342, 1165.27, 250.43, 14.07,   0.00, 0.00, 0.00);
	CreateObject(16344, 1562.99, 971.22, 18.23,   0.00, 0.00, 0.00);
	CreateObject(16343, 1457.01, 564.39, 17.21,   0.00, 0.00, 0.00);
	CreateObject(16345, 1497.66, 1327.61, 12.18,   0.00, 0.00, 0.00);
	CreateObject(16357, 1753.36, 1395.99, 9.72,   0.00, 0.00, 0.00);
