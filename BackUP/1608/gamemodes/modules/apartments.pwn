...
stock AddKV(playerid) 
{
    ...
    new Float:ExitX = GetPVarFloat(playerid, "aCarX");
    new Float:ExitY = GetPVarFloat(playerid, "aCarY");
    new Float:ExitZ = GetPVarFloat(playerid, "aCarZ");
    new Float:ExitA = GetPVarFloat(playerid, "aCarAngle");
